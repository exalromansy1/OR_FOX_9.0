...
FOX_BRANCH="fox_9.0"; # default is fox_12.1 (fox_9.0, fox_10.0, fox_11.0, fox_12.1 ?)
TWRP_BRANCH="twrp-9.0"; # default is twrp-12.1 (twrp-9.0, twrp-10.0, twrp-11.0, twrp-12.1 ?)
DEVICE_BRANCH="fox_12.1"; # device tree branch, default is fox_12.1
DEVICE_TREE_URL="https://github.com/exalromansy1/device_Infinix-X626B.git"; # device tree url, default is for miatoll
LOCAL_DEVICE_TREE_URL="git@github.com:exalromansy1/device_Infinix-X626B.git"; # local device tree url, default is for miatoll
FOX_VENDOR_BRANCH="fox_9.0"; # default is fox_12.1 (master, fox_10.0, fox_11.0, fox_12.1 ?)
# extras
TWRP_MIN_MANIFEST="omni"; # default is aosp (aosp, omni ?)
OEM="infinix"; # default is xiaomi (xiaomi,samsung,etc ?)

# the device whose tree we can clone for compiling a test build
test_build_device="Infinix-X626B"; # default is miatoll

# are we building for a virtual A/B (VAB) device?  (default is "no")
[ -z "$FOX_OMNI_DEVICE" ] && FOX_OMNI_DEVICE="0"; # default is 0
[ -z "$FOX_AOSP_DEVICE" ] && FOX_AOSP_DEVICE="0"; # default is 1
[ -z "$FOX_OMNI_VAB_DEVICE" ] && FOX_OMNI_VAB_DEVICE="1"; # default is 0
